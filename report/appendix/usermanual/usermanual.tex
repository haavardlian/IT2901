...
\todo{Picture of add device dialog and the plus symbol - er dette den riktige? Er ikke noe pluss-symbol der. Skal du bare ha dialogen, eller er det greit som det er?}
...
\todo{Add picture of the two "under tabs within the usage tab" REmove this todo if picture is ok}
\begin{figure}[H]
\centering
...
\todo{Add picture of your usage, a graph screenshot. Remove if done.}
...
To create your own tip, press the green plus symbol in the option bar. This will create a dialog where you must enter a name of your new tip, and a description. \todo{Er det noen restriksjoner på hva du kan skrive inn i denne dialogen? Type, må man ha beskrivelse etc.}
...
\todo{Picture of my tips tab. Usikker på hvilken av dem du mente,bare la inn det ene tip-bildet jeg fant. Fjern relevant todo}
