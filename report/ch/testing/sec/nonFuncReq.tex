...
The results from these tests was used to make improvements in the GUI. An example feedback document can be found in appendix\todo{add test results in appendix}.
