...
Based on the product requirements the team worked out along with the customer, some research on existing solutions in the same market was done.\todo{Restructure?} This resulted in a list of the most relevant solutions, possibly competing with the team's own app.
...
As that was not the only property the team would like to focus on, the solution lacked many of the features the team wanted to have in the app. Other drawbacks is that the product does not have any official support in Norway and also is beyond a reasonable price range. \todo{Rotete setninger?}
...
\todo{Skrev om dette, sjekk at det er greit}
...
\todo{Bilde over teksten? litt inkonsistent, er det bevist?}
