...
The team decided to use Git with GitHub~\cite{github} instead of alternative tools like SVN~\cite{svn} and Mercurial~\cite{mercurial}, because most of the team have experience with Git from previous projects. It was also requested by the customer\todo{ and it is used by cossmic?}. 
...
\todo{Merge de to over? står egentlig det samme}
...
This project uses Java\todo{'s ?}~\cite{javaconv} and Android's code conventions~\cite{androidconv}, as requested by the customer.
\todo{forklarer vi dette noe sted? ref ditt?}
