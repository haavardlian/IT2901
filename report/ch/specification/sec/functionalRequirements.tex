...
The functional requirements of a system are the specific features that together describe the overall functionality. Table~\ref{tab:funcReq} represents a complete list of the functional requirements the approved by the customer. An overview of how these requirements were tested is presented in section~\ref{sec:funcTest}.
...
\item FR3.4. The user should also be able to add energy saving tips he want to do in the future.
