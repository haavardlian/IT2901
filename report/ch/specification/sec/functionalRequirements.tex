...
The functional requirements of a system are the specific parts on functionality that together describe the overall functionality. These requirements are given in table~\ref{tab:funcReq}.

An overview of how these requirements were tested is presented in chapter~\ref{sec:funcTest}.
