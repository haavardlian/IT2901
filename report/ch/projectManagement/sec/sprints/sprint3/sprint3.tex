...
After this sprint the app has detailed protypes for each part of the app. \todo[inline]{Må ha bilder av prototypene.} Some progress was also made on the actual implementation of the app.
