...
concluded with an end meeting. An illustration of this process can be seen in figure ~\ref{fig:scrumProcess}.
\begin{figure}[H]
...
\todo{move? In the team's planning poker sessions, it was decided to use the units small (S), medium (M), large (L) and extra large (XL), each of them respectively representing one hour (S), two hours (M), four hours (L) and eight hours(XL).}
...
\todo{move? subsubsectionOur process
