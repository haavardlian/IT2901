...
The product owner adds the user stories to the product backlog, which are then selected from the product backlog and moved to the sprint backlog. This process is repeated until the limit of number of estimated work hours is reached. 
