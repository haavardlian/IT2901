\newpage
\subsection{Scrum}
\todo[inline]{rephrase or remove: The concept behind the Scrum approach is to empower the entire team to make
...
\todo[inline]{refer to this illustration in the text}
...
\todo[inline]{move? In the team's planning poker sessions, it was decided to use the units small (S), medium (M), large (L) and extra large (XL), each of them respectively representing one hour (S), two hours (M), four hours (L) and eight hours(XL).}
...
\todo[inline]{move? subsubsectionOur process
