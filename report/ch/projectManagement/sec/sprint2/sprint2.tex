...
As mentioned in section~\ref{sec:scrumtools}, the team used a lot of time on
...
\label{fig:wrongUse}
\caption{Example screen shot to illustrate improper use of Yodiz}
\end{figure}

\begin{figure}[H]
\includegraphics[width=\textwidth]{ch/sprints/fig/addsTasks.png}
\label{fig:addsTasks}
\caption{Example screen shot to illustrate how the team resolved the issue.}
\end{figure}
