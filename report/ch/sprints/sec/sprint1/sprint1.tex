...
The team has previous experience with iceScrum. After a discussion, the team came to the conclusion that iceScrum was not to be used again and that an alternative was needed. The reason why this was decided is that iceScrum must be deployed on a server, \todo{and it is restrictive in how to use it.}
